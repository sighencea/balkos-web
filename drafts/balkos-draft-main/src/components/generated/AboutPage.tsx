          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white border border-slate-200 p-6">
                <h3 className="font-semibold text-slate-900 mb-3">Fakten</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              {['Personalleasing für Industriebetrieb und -wartung', 'Industrielle Instandhaltungsunterstützung', 'Rohrleitungsbau und -fertigung', 'Shutdown- und Turnaround-Dienstleistungen'].map((service, i) => <div key={i} className="flex items-start space-x-3 p-4 bg-slate-50 border border-slate-200">
                  <CheckCircle className="w-6 h-6 text-orange-500 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">{service}</span>
                </div>)}
            </div>

            <div className="bg-slate-50 border-l-4 border-orange-500 p-6">
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            }].map(step => <div key={step.num} className="flex items-start space-x-4 p-4 bg-white border border-slate-200">
